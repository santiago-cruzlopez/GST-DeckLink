"""
    1. DeckLink Video using GStreamer with CUDA - Adding Gaussian Noise
...
def sdi_frames(element, buffer):
    ...
    if success:
        try:
            ...
            mean = 0
            sigma = 30  # Adjust noise intensity
    ...
    if processing_time > 33:
        print("Warning: Processing time exceeds frame interval")
...
def GStreamer_Pipeline():
    ...
    # Identity element for GPU processing
